...
**🔗 라이브 데모**: 대회 기간(2026.08.27–29) 한정 운영 — 현재 종료
...
박진수는 **기획·인프라 구축·v1 및 v2 전체 개발**을 담당했습니다. 위 표는 당초 역할 분담이며, 최종 코드 구현 범위와 구분합니다. 5인 팀의 해커톤 프로젝트로, 개인 프로젝트로 표기하지 않습니다.

- 초기 버전: [receipt-tribunal](https://github.com/1jsjs/receipt-tribunal)
- 최종 버전: 이 저장소(sobi-tribunal)
- 결과: 2026 제2회 호남권 SW중심대학 LLM 해커톤 **장려상**
